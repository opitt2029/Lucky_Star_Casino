...
export const decorativeAssets = {
  ...
  slotGame: {
    image: 'game-slot-lobby-card.png',
    position: 'center',
    size: 'cover',
    meta: 'Slot Game',
    label: '老虎機挑戰',
  ...
  baccaratGame: {
    image: 'game-baccarat-lobby-card.png',
    position: 'center',
    size: 'cover',
    meta: 'Baccarat',
    label: '百家樂牌局',
  ...
  fishingGame: {
    image: 'game-fishing-lobby-card.png',
    position: 'center',
    size: 'cover',
    meta: 'Fishing',
    label: '深海捕魚場',
  ...
  provablyFair: {
    image: 'game-fairness-lobby-card.png',
    position: 'center',
    size: 'cover',
    meta: 'Provably Fair',
    label: '公平性驗證展示',
  ...
  shopPrizeA: {
    ...
    overlay: 'linear-gradient(135deg, rgba(255, 214, 86, 0.08) 0%, rgba(24, 1, 4, 0.68) 100%)',
  },
  shopPrizeB: {
    ...
    overlay: 'linear-gradient(135deg, rgba(248, 213, 106, 0.08) 0%, rgba(28, 1, 5, 0.7) 100%)',
  },
  shopPrizeC: {
  ...
  shopRoyalNameplate: {
    ...
    overlay: 'linear-gradient(135deg, rgba(255, 225, 128, 0.1) 0%, rgba(35, 2, 8, 0.72) 100%)',
  },
  shopTitleBadge: {
    ...
    overlay: 'linear-gradient(135deg, rgba(86, 180, 255, 0.12) 0%, rgba(16, 2, 28, 0.75) 100%)',
  },
  shopProfileBackdrop: {
    ...
    overlay: 'linear-gradient(135deg, rgba(90, 95, 255, 0.12) 0%, rgba(16, 2, 34, 0.76) 100%)',
  },
  shopCoinRain: {
    ...
    overlay: 'linear-gradient(135deg, rgba(255, 198, 64, 0.14) 0%, rgba(28, 8, 1, 0.74) 100%)',
  },
  shopLuckPass: {
    ...
    overlay: 'linear-gradient(135deg, rgba(52, 211, 153, 0.12) 0%, rgba(2, 32, 24, 0.76) 100%)',
  },
  shopHighRollerInvite: {
    ...
    overlay: 'linear-gradient(135deg, rgba(255, 214, 86, 0.1) 0%, rgba(19, 8, 28, 0.76) 100%)',
  },
  shopLuckyCharm: {
    ...
    overlay: 'linear-gradient(135deg, rgba(252, 165, 165, 0.13) 0%, rgba(42, 4, 8, 0.74) 100%)',
  },
}
...
export const backgroundTheme = {
  ...
  authHero: {
    color: '#180103',
    image: 'casino-city-hero.png',
    overlay: 'linear-gradient(180deg, rgba(108, 6, 13, 0.54) 0%, rgba(18, 1, 4, 0.9) 100%)',
    accent:
...
export function getDecorativeAssetStyle(name) {
  ...
  return {
    ...
    '--decorative-overlay':
      preset.overlay || 'linear-gradient(135deg, rgba(24, 24, 27, 0.72), rgba(9, 9, 11, 0.92))',
    '--decorative-position': preset.position || 'center',
    '--decorative-size': preset.size || 'cover',
  }
}
