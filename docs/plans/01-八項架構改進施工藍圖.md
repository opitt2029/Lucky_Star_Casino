...
| P2b | T-090 壓測完整實跑 | L | ✅ 已完成（PR #169 中途進度；完整結果與根因鏈見 CHANGELOG 2026-07-08、T-090 報告。TimeLimiter 修正後 2026-07-08 已完成 1,000 併發重跑驗證：熔斷誤判消除、帳務 gate 全 PASS、效能 gate 仍 FAIL 屬下一輪調校） |
...
> P4/P5/P6/P7/P8 皆已由其他協作者（weiyu 等）在本檔第一版發出後陸續合併完成；本表已據 `gh pr list` 與 CHANGELOG 交叉核對更新。僅 P3（Lua CAS）仍未動工。
